...
function Experience() {
  ...
  <div>
              ...
              <div className="lg:flex gap-10">
                <div className="text-center shadow-lg p-10 rounded-xl my-5  dark:bg-white flex-1">

                  <h3 className="text-lg font-medium pt-8 pb-2  py-4 text-blue-900">
                    .Net Developer
                ...
                <div className="text-center shadow-lg p-10 rounded-xl my-5 dark:bg-white flex-1">
                  <h3 className="text-lg font-medium pt-8 pb-2  py-4 text-blue-900">IT Support</h3>
                  <p className="py-1">
